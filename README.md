...
![Гистограмма предсказаний модели](/services/prometheus/hist.png)

Частота запросов к основному сервису
![Частота запросов к основному сервису](/services/prometheus/rate200.png)

Частота запросов к сервису с кодами ошибок 4** и 5**
![Количество запросов к сервису с кодами ошибок 4** и 5**](/services/prometheus/rate400.png)
...
Панель
![Panel](/services/grafana/panel.png)
